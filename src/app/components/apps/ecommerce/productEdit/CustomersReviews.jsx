                ...
                >
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell>
                                <Typography variant="subtitle2" fontWeight={600}>Comment</Typography>
                            </TableCell>
                            <TableCell>
                                <Typography textAlign="right" variant="subtitle2" fontWeight={600}>Date</Typography>
                            </TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                            ...
                            <TableRow key={basic.id}>
                                ...
                                <TableCell>
                                    <Rating
                                        ...
                                        value={basic.rating} size="small"
                                    />
                                    <Typography color="textSecondary" variant="subtitle2" fontSize="14px" fontWeight={400} sx={{
                                        maxWidth: { lg: '350px', xs: '150px' }, whiteSpace: 'wrap'
                                ...
                                <TableCell>
                                    <Typography variant="body2"  textAlign="right">{basic.date}</Typography>
                                </TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
