...
const PricingCard = () => {
    ...
    return (
        <Box p={3}>
            <Typography variant='h5' mb={3}>Pricing</Typography>

            <Grid container spacing={3}>
                {/* 1 */}
                <Grid item xs={12}>
                    <CustomFormLabel htmlFor="p_price" sx={{ mt: 0 }}>
                        Base Price <Typography color="error.main" component="span">*</Typography>
                    </CustomFormLabel>
                ...
                <Grid item xs={12}>
                    <CustomFormLabel htmlFor="p_price" sx={{ mt: 0 }}>
                        Discount Type <Typography color="error.main" component="span">*</Typography>
                    </CustomFormLabel>
                    <RadioGroup
                        row
                    ...
                    >
                        <Stack direction="row" spacing={3} width='100%' useFlexGap flexWrap="wrap">
                            <Box px={2} py={1} flexGrow={1} sx={{
                                border: `1px dashed ${theme.palette.divider}`, textAlign: 'center'
                            }}>
...

                    {
                        selectedValue === 'percentage' && (
                            <>
                                <CustomFormLabel>
                                    Set Discount Percentage <Typography color="error.main" component="span">*</Typography>
                                </CustomFormLabel>
                        ...
                        selectedValue === 'fixed' && (
                            <>
                                <CustomFormLabel htmlFor="p_fixed">
                                    Fixed Discounted Price <Typography color="error.main" component="span">*</Typography>
                                </CustomFormLabel>
                ...
                <Grid item xs={12} lg={6}>
                    <CustomFormLabel htmlFor="p_tax" sx={{ mt: 0 }}>
                        Tax Class <Typography color="error.main" component="span">*</Typography>
                    </CustomFormLabel>
                    <CustomSelect
                        id="p_tax"
                        value={age}
                ...
                <Grid item xs={12} lg={6}>
                    <CustomFormLabel htmlFor="p_vat" sx={{ mt: 0 }}>
                        VAT Amount (%) <Typography color="error.main" component="span">*</Typography>
                    </CustomFormLabel>
