...
const ProductTemplate = () => {
  ...
  return (
    <Box p={3}>
      <Typography variant='h5' mb={3}>Product Template</Typography>
      <Grid container spacing={3}>
        <Grid item xs={12}>
          ...
          <Typography variant="body2" mt={1}>Assign a template from your current theme to define how a single product is displayed.</Typography>
        </Grid>
      </Grid>
    </Box>
  );
