...
const COMMON_TAB = [
    { value: '1', icon: <IconUserCircle width={20} height={20} />, label: 'Team Scheduling', disabled: false },
    { value: '2', icon: <IconWallet width={20} height={20} />, label: 'Payments', disabled: false },
    { value: '3', icon: <IconAppWindow width={20} height={20} />, label: 'Embedding', disabled: true },
    { value: '4', icon: <IconArrowRampLeft width={20} height={20} />, label: 'Workflows', disabled: true },
];
                    ...
                    <Box sx={{ maxWidth: { xs: 400, sm: '100%' } }}>
                        <TabList TabIndicatorProps={{
                            ...
                            {COMMON_TAB.map((tab, index) => (
                                <StyledTab key={tab.value} label={tab.label} iconPosition="start" icon={tab.icon} value={String(index + 1)} sx={{
                                    fontSize: {
                                        xs: '15px',
                                        lg: '18px'
                                    },
