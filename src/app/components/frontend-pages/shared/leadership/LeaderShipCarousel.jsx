        ...
        <Slider {...settings} className="leadership-carousel" style={{ marginLeft: '15px' }}>
            <div style={slideStyle}>
                ...
                <UserBox bgcolor="white" px='10px' py='16px' textAlign="center" position="relative" zIndex="1">
                    <Typography variant="h5" mb={1}>Alex Martinez</Typography>
            ...
            <div style={slideStyle}>
                ...
                <UserBox bgcolor="white" px='10px' py='16px' textAlign="center" position="relative" zIndex="1">
                    <Typography variant="h5" mb={1}>Jordan Nguyen</Typography>
            ...
            <div style={slideStyle}>
                ...
                <UserBox bgcolor="white" px='10px' py='16px' textAlign="center" position="relative" zIndex="1">
                    <Typography variant="h5" mb={1}>Taylor Roberts</Typography>
            ...
            <div style={slideStyle}>
                ...
                <UserBox bgcolor="white" px='10px' py='16px' textAlign="center" position="relative" zIndex="1">
                    <Typography variant="h5" mb={1}>Morgan Patel</Typography>
            ...
            <div style={slideStyle}>
                ...
                <UserBox bgcolor="white" px='10px' py='16px' textAlign="center" position="relative" zIndex="1">
                    <Typography variant="h5" mb={1}>Kiana Collins</Typography>
                    <Typography variant="body1">Software Developer</Typography>
                </UserBox>
            </div>
            <div style={slideStyle}>
                <Image src='/images/frontend-pages/homepage/user1.jpg' alt="user-img" width={270} height={290} objectFit="cover" style={{ borderRadius: '16px' }} />
                <UserBox bgcolor="white" px='10px' py='16px' textAlign="center" position="relative" zIndex="1">
                    <Typography variant="h5" mb={1}>Alex Martinez</Typography>
                    <Typography variant="body1">CEO & Co-Founder</Typography>
                </UserBox>
